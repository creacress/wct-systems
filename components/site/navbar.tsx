  ...
  />
          ...
          <div className="px-6 py-5">
            <div className="grid gap-2">
              ...
              <Link
                href={ctaHref}
                className="mt-2 inline-flex items-center justify-center rounded-2xl bg-violet-600 px-4 py-3 text-sm font-medium text-white shadow-sm shadow-violet-500/20 transition hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500/30"
              >
                {ctaLabel}
              </Link>
            </div>
