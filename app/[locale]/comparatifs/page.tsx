...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${siteUrl}${locale === "pt" ? "/pt/comparacoes" : "/comparatifs"}`,
      languages: {
        fr: `${siteUrl}/comparatifs`,
        "pt-PT": `${siteUrl}/pt/comparacoes`,
        "x-default": `${siteUrl}/comparatifs`,
      },
    },
    openGraph: {
...
export default async function ComparatifsIndexPage() {
  const t = await getTranslations('comparatifs');
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: t('index.jsonld_comparatifs'), item: `${SITE_URL}/comparatifs` },
        ],
      },
      {
        "@type": "ItemList",
    ...
    <main id="content" className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        ...
        <Breadcrumbs items={[
          ...
          { label: t('index.breadcrumb_comparatifs') },
        ]} />
        ...
        <ScrollReveal direction="up" delay={80}>
          <section className="mt-14" aria-label={t('index.breadcrumb_comparatifs')}>
