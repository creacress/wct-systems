      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        ...
        <section className="mt-16 sm:mt-24 space-y-8" id="templates">
          <div className="space-y-2">
            <h2 className="text-2xl font-semibold tracking-tight">12 templates métier</h2>
              ...
              return (
                <article
                  ...
                  className={`group relative flex flex-col overflow-hidden rounded-3xl shadow-sm backdrop-blur transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                    isSurMesure
                      ? "border-2 border-dashed border-violet-300 bg-linear-to-br from-violet-50/80 to-indigo-50/60 dark:border-violet-500/30 dark:from-violet-950/30 dark:to-indigo-950/20 dark:hover:border-violet-400/50 dark:hover:shadow-violet-500/10"
                      : "border bg-background/60 dark:border-white/[0.08] dark:bg-white/[0.04] dark:hover:border-violet-500/20 dark:hover:bg-white/[0.06] dark:hover:shadow-violet-500/10"
                  }`}
                >
                  {/* Live preview iframe */}
                  {hasPreview ? (
                    ...
                    >
                      {/* Mini browser bar */}
                      <div className="flex items-center gap-1.5 bg-muted/80 px-3 py-2 dark:bg-white/[0.06]">
                      ...
                      <div className="relative aspect-[16/10] w-full overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-black/0 transition-colors duration-300 group-hover:bg-black/30">
                          <span className="rounded-2xl bg-white/90 px-4 py-2 text-xs font-medium text-violet-700 opacity-0 shadow-lg transition-opacity duration-300 group-hover:opacity-100 dark:bg-violet-950/90 dark:text-violet-300">
                            Voir la démo
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex aspect-[16/10] w-full items-center justify-center border-b bg-linear-to-br from-violet-100/60 to-indigo-100/40 dark:border-white/[0.06] dark:from-violet-950/40 dark:to-indigo-950/20">
                  ...
                  <div className="flex grow flex-col p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-50 text-lg dark:bg-violet-950/50">
                        {t.icon}
                      </span>
                      <span className="rounded-full border border-violet-200 bg-violet-50 px-2.5 py-0.5 text-xs font-medium text-violet-700 dark:border-violet-800 dark:bg-violet-950/50 dark:text-violet-300">
                        {t.sector}
                      </span>
                    </div>
          ...
          <div className="rounded-3xl border bg-muted/40 p-6 text-center dark:border-white/[0.06] dark:bg-violet-500/[0.03]">
            <p className="text-sm text-muted-foreground">
              Votre secteur n&apos;est pas dans la liste ?{" "}
              <Link href="/contact?service=site-web" className="font-medium text-violet-600 underline hover:opacity-80 dark:text-violet-400">
                Contactez-nous
              </Link>
        ...
        <section className="mt-16 sm:mt-24 space-y-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              ...
              <div key={x.k} className="rounded-3xl border bg-background/60 p-6 shadow-sm backdrop-blur dark:border-white/[0.08] dark:bg-white/[0.04]">
        ...
        {/* PROCESS */}
        <section className="mt-16 sm:mt-24 space-y-8">
          <h2 className="text-2xl font-semibold tracking-tight">Le process en 4 étapes</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={x.step}
                className="rounded-3xl border bg-muted/40 p-6 transition hover:bg-muted dark:border-white/[0.06] dark:bg-violet-500/[0.03] dark:hover:bg-violet-500/[0.06]"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-violet-100 text-sm font-semibold text-violet-700 dark:bg-violet-950/50 dark:text-violet-300">
                  {x.step}
                </div>
        ...
        <section className="mt-20">
          <div className="rounded-3xl border bg-linear-to-r from-violet-50 to-indigo-50/80 dark:from-violet-950/40 dark:to-indigo-950/30 p-10 text-center shadow-sm dark:border-violet-500/20 dark:shadow-lg dark:shadow-violet-500/10">
            <h2 className="text-3xl font-semibold tracking-tight">Prêt pour un site qui convertit ?</h2>
